...
def build_receipt_image(data):
    ...
    title = data.get("title") or "Smart Crypto Buy"
    ...
    for label, value in rows:
        draw.text((90, y), label.upper(), font=label_font, fill=(129, 72, 40, 255))
        y = draw_receipt_text(draw, (90, y + 34), value, value_font, (35, 35, 35, 255), width - 180)
        y += 24
