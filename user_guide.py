...
━━━━━━━━━━━━━━━━━━━━━
💠 🛰️ নিজের encrypted wallet ব্যবহার করে supported network-এ crypto পাঠানো যাবে।
💠 🔋 Balance দেখা, wallet key change/delete করা এবং transaction status check করা যাবে।
💠 🌀 Buy flow, 🌟 Stars, 💡 FAQ, 📡 Status এবং 🧠 AI Support menu থেকে আলাদা সাহায্য পাওয়া যাবে।
...
⚠️ Network select করার সময় receiving wallet একই network-এর কিনা নিশ্চিত করুন। ভুল network বা ভুল wallet-এ পাঠালে transaction ফিরিয়ে আনা যায় না।

💎 ৩. প্রথমবার wallet setup
━━━━━━━━━━━━━━━━━━━━━
১) /setup কমান্ড দিন।
২) আপনার wallet network বেছে নিন।
৩) 🔑 private key পাঠান। Bot message পাওয়ার পর key encrypt করে রাখে।
৪) 💎 শক্তিশালী password তৈরি করুন। এই password দিয়ে key unlock হবে।
৫) 🛡️ setup complete হলে wallet address দেখাবে।

⚠️ Password ভুলে গেলে bot আপনার key recover করতে পারবে না। প্রয়োজনে /deletekey দিয়ে নতুন setup করতে হবে।

🔋 ৪. Balance check
━━━━━━━━━━━━━━━━━━━━━
💠 /mybalance কমান্ড দিন।
💠 Bot password চাইবে।
💠 🛡️ সঠিক password দিলে selected wallet-এর balance দেখাবে।

🕒 Balance দেখাতে RPC/API delay হতে পারে। Balance কম দেখালে কিছু সময় পরে আবার check করুন।

🛰️ ৫. নিজের wallet থেকে crypto পাঠানো
━━━━━━━━━━━━━━━━━━━━━
...
৬) 🛡️ transaction successful হলে hash/receipt দেখাবে।

⚠️ Send করার আগে amount, destination wallet এবং network মিলিয়ে নিন। Blockchain transaction irreversible।
...
💠 ✖️ /deletekey: saved encrypted key delete করে।

⚠️ Key change/delete করার আগে নিশ্চিত হয়ে নিন, কারণ delete করলে bot থেকে পুরনো key ফেরত পাওয়া যাবে না।

🛡️ ৮. Security rules
━━━━━━━━━━━━━━━━━━━━━
💠 🔑 private key, seed phrase বা wallet password কাউকে দেবেন না।
💠 🛠️ support/admin কখনো private key বা seed phrase চাইবে না।
💠 📡 public wallet address share করা যায়, কিন্তু private key করা যাবে না।
💠 💎 password শক্তিশালী রাখুন এবং আলাদা জায়গায় নিরাপদে সংরক্ষণ করুন।
💠 ⚠️ suspicious link বা fake support account-এ key দেবেন না।

📡 ৯. Order, payment এবং support
━━━━━━━━━━━━━━━━━━━━━
💠 📈 Buy order check করতে 📡 Order Status menu বা /order ORD-XXXXXX ব্যবহার করুন।
💠 💳 Payment করার আগে network, wallet, amount এবং bKash number মিলিয়ে নিন।
💠 🕒 bKash/SMS notice delay হলে order pending থাকতে পারে।
💠 💡 FAQ button-এ সাধারণ প্রশ্নের উত্তর আছে।
💠 🧠 দ্রুত guidance দরকার হলে AI Support ব্যবহার করুন। 🛠️ Manual help: @MdMouno

✖️ ১০. Common problem
━━━━━━━━━━━━━━━━━━━━━
💠 💎 Wrong password: আবার সঠিক password দিন।
💠 ⛽ Insufficient gas: native gas token top up করুন।
💠 ✖️ Invalid wallet: selected network অনুযায়ী wallet address দিন।
💠 ⚠️ Send failed: hash না এলে support/admin-এর সাথে verify করুন।
