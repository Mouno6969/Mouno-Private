...
AI_PROVIDER_ORDER = os.getenv("AI_PROVIDER_ORDER", "groq,nvidia_deepseek,nvidia_kimi,nvidia_gemma,gemini,openrouter,mistral,cohere,nvidia_mistral_small,nvidia_llama4_scout,nvidia_nemotron_nano,nvidia_qwen_7b,nvidia_llama_8b,huggingface")
...
SCB_FORWARDER_APP_URL = os.getenv("SCB_FORWARDER_APP_URL", "https://github.com/Mouno6969/Mouno-Private/actions/workflows/build-android-forwarder.yml")
