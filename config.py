...
AI_PROVIDER_ORDER = os.getenv("AI_PROVIDER_ORDER", "nvidia_llama_8b,nvidia_qwen_7b,nvidia_mistral_small,nvidia_nemotron_nano,nvidia_llama4_scout,groq,openrouter,gemini,huggingface,cohere,mistral,nvidia_kimi,nvidia_deepseek,nvidia_gemma")
