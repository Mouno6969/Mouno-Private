...
AI_PROVIDER_ORDER = os.getenv("AI_PROVIDER_ORDER", "nvidia_deepseek,nvidia_kimi,nvidia_gemma,gemini,openrouter,mistral,cohere,groq,nvidia_mistral_small,nvidia_llama4_scout,nvidia_nemotron_nano,nvidia_qwen_7b,nvidia_llama_8b,huggingface")
