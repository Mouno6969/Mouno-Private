...
import { RefreshCw, Settings, Info, ArrowDown, Zap, ShieldCheck } from 'lucide-react';
      ...
      <div className="lg:col-span-3">
        <Card className="shadow-2xl border-primary/10 relative overflow-hidden">
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-7">
            <CardTitle className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Bridge Interface</CardTitle>
          ...
          <CardFooter className="pt-2">
            ...
            >
              {loading ? (
                <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Calculating Best Route...</>
              ) : (
                <>Get Quote</>
              )}
            </Button>
